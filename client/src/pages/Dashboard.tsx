...
import { Activity, FlameIcon, HamburgerIcon, RulerIcon, ScaleIcon, TrendingUpIcon, ZapIcon } from "lucide-react"
  ...
  return (
    <div className="page-container">
      ...
      <div className="dashboard-card-grid">
        ...
        { /* Goal Card */ }
        {user && ( // This card will span both columns on large screen
                  ...
                  <div className="flex justify-between items-center mb-2">
                    ...
                    {(() => {
                      ...
                      const getStatus = (b: number) => {
                        if(b < 18.5) return {color: 'text-blue-500', bg: 'bg-blue-500'};
                        if(b < 25) return {color: 'text-emerald-500', bg: 'bg-emerald-500'};
                        if(b < 30) return {color: 'text-orange-500', bg: 'bg-orange-500'};
        ...
        <Card className="col-span-2">
          <h3 className="font-semibold text-slate-800 dark:text-white mb-2">Weekly Progress</h3>
          <CaloriesChart />
        </Card>
